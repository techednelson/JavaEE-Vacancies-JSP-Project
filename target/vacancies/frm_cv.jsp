    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title"><b>Submit CV for vacancy: ${vacancy.vacancyName}</b></h3>
        </div>
        <div class="panel-body">
          ...
          <form action="application" method="post" enctype="multipart/form-data">
             <div class="form-group">
              ...
              <input type="text" class="form-control" name="name" value="${application.name}" required id="name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="phone" value="${application.phone}" required id="phone">
            </div>
            <div class="form-group">
              <label for="address">Address</label>
              <input type="text" class="form-control" name="address" value="${application.address}" required id="address">
            </div>
            <div class="form-group">
